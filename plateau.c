    ...
    while (1) {
        ...
        if (key == 'z' && y > 1) {
            if (tab[y - 1][x] == 3 || tab[y - 1][x] == 5) {
                tab[y - 1][x] = 0; // Fait disparaître le "A" et le bloc cassable si le personnage passe dessus
                if (tab[x][y] == 0) {
                    printf(" ");
                }
            }
            ...
            if (tab[y][x - 1] == 3 || tab[y][x - 1] == 5) {
                tab[y][x - 1] = 0; // Fait disparaître le "A" et le bloc cassable si le personnage passe dessus
                if (tab[x][y - 1] == 0) {
                    printf(" ");
                }
            }
