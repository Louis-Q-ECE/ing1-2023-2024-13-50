    ...
    for (int a = 0; a < 12; a++) {
        for (int b = 0; b < 22; b++) {
            if (a == 0 || a == 11) {
                ...
                tab[a][b] = 3;
            } else if (a == 4 && b == 10 || a == 9 && b == 20 || a == 9 && b == 19 || a == 9 && b == 18 || a == 9 && b == 17 || a == 9 && b == 16) { // bloc poussable vers le haut
                tab[a][b] = 4;
            }else if (a == 6 && b == 10) { // bloc poussable vers le bas
                tab[a][b] = 10;
            }else if (a == 9 && b == 3 || a == 5 && b == 9) { // bloc poussable vers la gauche
                tab[a][b] = 11;
            } else if (a == 2 && b == 19 || a == 5 && b == 11) { // bloc poussable vers la droite
                tab[a][b] = 12;
            } else if (a==5 && b==1 ||a == 8 && b == 3 ||a == 5 && b == 2 ||a == 10 && b == 3 ||a == 1 && b == 19 || a == 10 && b == 16) { // bloc cassable
                tab[a][b] = 5;
